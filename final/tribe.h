...
* Tribe Container
*
* Implements a Tribe container type.
*
...
* @param new_tribe_id - The tribe id element which need to be assigned.
* @param tribe_name - The new tribe name  to associate with the given id.
...
* @param new_tribe_id - The tribe id element which need to be modified.
* @param tribe_name - The new tribe name  to associate with the given id.
*                     A copy of the tribe name will be inserted.
* @return
* 	TRIBE_OUT_OF_MEMORY if an allocation failed 
