...
* also for each area can store information of votes or others
...
*   areaRemoveAllVotesfromTribe - removes all votes from specific tribe 
...
* @param area_id - The area id which votes will be added to
* @param tribe_id - the elected tribe
...
* @param area_id - The area id element which to remove votes. 
* @param tribe_id - the elected tribe
...
* @param map - the map to put the election results to
* @return
*   AREA_OUT_OF_MEMORY if an allocation failed 
* 	AREA_ERROR if other error occurred 
* 	AREA_SUCCESS the tribe votes removed successfully
